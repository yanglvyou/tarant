...
export default function Home(): JSX.Element {
  ...
  return (
    <Layout title={`${siteConfig.title}`} description="Tarant 官网">
      <main className={styles.container}>
        <div className={styles.left}>
          <p className={styles.title}>OSSA</p>
          <p className={styles.slogon}>轻量、可靠的小程序端 Taro React UI 组件库</p>
          ...
          <div className={styles.btnGrounp}>
            ...
            <Link href="/docs/start" className={clsx(styles.start, styles.btn)}>
              快速开始
            </Link>
          </div>
        </div>
