      ...
      <View className="index page page-home">
        <View className="index-head">
          ...
          <View className="index-head__texts">
            <View className="index-head__title">Tarant</View>
            <View className="index-head__desc">企业级UI库</View>
          </View>
        </View>
        <View className="index__body">
          {list.map((item: NavItem) => (
            <View key={item.id} data-id={item.id} onClick={this.onClick} className="index__list">
              <DemoListRow
                title={item.title}
                subTitle={item.desc}
